  ...
  if (status === 'authenticated') {
    return (
      <>
        ...
        <div className='hidden sm:inline-flex sticky flex-col top-0 z-50 items-center pb-10 lg:px-5 h-min-24 border-none p-5 w-full bg-gradient-to-b from-[#3A4F6F] to-chas-secondary'>
