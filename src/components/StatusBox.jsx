    ...
    <div className=" bg-white p-2 rounded-2xl shadow-md text-gray-500 font-medium mt-6">
        <div className="flex sm:space-x-4 p-4 items-center max-w-full">
            ...
            <form className=" flex flex-1 break-words">
                ...
                />
                <button className="hidden" type="submit" onClick={handleNewPost}>Submit</button>
            </form>
            {uploadImages && (
        ...
        <div className=" justify-evenly flex p-3 border-t">
             ...
             <div className="inputIcon flex-col sm:flex-row" onClick={()=> imageRef.current.click()}>
                <CameraIcon className=" h-7 text-green-400"/>
                <p className="text-xs sm:text-sm xl:text-base">Photo/Video</p>
                <input  ref={imageRef} type="file" multiple  id='image'
            name='image'accept='image/png, image/jpeg, image/webp' onChange={(e) => {
